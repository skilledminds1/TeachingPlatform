 ...
 * mismatch on every profile and course page, and `suppressHydrationWarning` does not cover
 * it — React special-cases the attribute. Measured, not assumed: the warning was reproduced
 * and then eliminated by removing the nonce.
 *
 ...
 *
 * THE ESCAPE still matters. The payload carries user-authored text — bios, descriptions,
