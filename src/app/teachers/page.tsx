...
export const metadata: Metadata = {
  title: "Find tutors",
  description:
    "Browse verified teachers on Amazing Skills. Filter by subject, rate, and rating, then book a live lesson.",
};
    ...
    <div className="min-h-screen bg-muted/20">
      ...
      <main className="mx-auto max-w-6xl space-y-6 px-6 py-10">
        <div className="space-y-1">
          <h1 className="text-3xl font-semibold tracking-tight">Find your teacher</h1>
          <p className="text-muted-foreground">
            Every profile is verified before it appears here. Lessons are live video, one on one.
          </p>
        </div>
        ...
        {teachers.length > 0 ? (
          ...
          <div className="rounded-xl border border-border bg-card shadow-sm">
            <EmptyState
              ...
              description="Try clearing a filter or searching for a different subject. New teachers join after admin approval."
            />
          </div>
        )}
      </main>
