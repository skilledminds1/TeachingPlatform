...
## Phase 7 — Teacher Payments (teacher's own payment link)

- Teacher saves a hosted-checkout link from their own provider in settings
...
- The teacher marks the payment received; the platform never sees it
